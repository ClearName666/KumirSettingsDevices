...
import com.example.kumirsettingupdevices.databinding.FragmentA61Binding
import com.example.kumirsettingupdevices.usb.UsbCommandsProtocol
import com.example.kumirsettingupdevices.usb.UsbFragment

class A61Fragment : Fragment(), UsbFragment {

    private lateinit var binding: FragmentA61Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentA61Binding.inflate(inflater)
        return binding.root
    }
